# 安卓工程师面试指南
- 由于外部环境，加上行业发展限制，最近互联网企业员工找工作需求增多。本人打算总结共享安卓面试的一些基础知识点和常问的问题，整理期间，尽量做到每周更新2-3次。希望能够对大家有所启发。有错误或者讲解不清晰之处欢迎大家指正，希望与诸君共勉---爱学习的小小酥
...
- [适配器模式](./android/设计模式/适配器.md)
- [观察者模式](./android/设计模式/观察者.md)
- [策略模式](./android/设计模式/策略模式.md)
- [责任链模式](./android/设计模式/责任链模式.md)
